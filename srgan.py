...
from HandleData import load_part_srgan
import datetime
...
class SRGAN():
    ...
    def build_vgg(self):
        ...
        """
        vgg = VGG19(weights="imagenet",output_layer='prob')
    ...
    def train(self, epochs, batch_size=1, sample_interval=50):
		...
		for i in range (0,20000):
		    ...
		    (imgs_hr, imgs_lr,_,_) = load_part_srgan('UTKFace/',i*batch_size,(i+1)*batch_size,None)
