...
def VGG19(include_top=True,
    ...
    x = layers.MaxPooling2D((2, 2), strides=(2, 2), name='block1_pool')(block1_conv2)
    ...
    x = layers.MaxPooling2D((2, 2), strides=(2, 2), name='block2_pool')(block2_conv2)
    ...
    block3_conv4 = layers.Conv2D(256, (3, 3),
                      activation='relu',
                      padding='same',
                      name='block3_conv4')(block3_conv3)
    x = layers.MaxPooling2D((2, 2), strides=(2, 2), name='block3_pool')(block3_conv4)
    ...
    block4_conv4 = layers.Conv2D(512, (3, 3),
                      activation='relu',
                      padding='same',
                      name='block4_conv4')(block4_conv3)
    x = layers.MaxPooling2D((2, 2), strides=(2, 2), name='block4_pool')(block4_conv4)
    ...
    block5_conv4 = layers.Conv2D(512, (3, 3),
                      activation='relu',
                      padding='same',
                      name='block5_conv4')(block5_conv3)
    x = layers.MaxPooling2D((2, 2), strides=(2, 2), name='block5_pool')(block5_conv4)
    ...
    if include_top:
        ...
        x = layers.Dense(classes, activation=layers.Activation(tf.nn.softmax), name='predictions')(x)
    else:
        if pooling == 'avg':
	...
	return models.Model(inputs=model.inputs,outputs=[block1_conv1,block2_conv1,block3_conv1],name='vgg-face')
    if output_layer == 'vae_345':
	return models.Model(inputs=model.inputs,outputs=[block3_conv1,block4_conv1,block5_conv1],name='vgg-face')		
